		...
		public function enqueue_script() {
			...
			if ( 'post-new.php' == $pagenow || 'post.php' == $pagenow ) {
				...
				if ( 'aiosrs-schema' == $screen->post_type ) {
					...
					wp_localize_script( 'aiosrs-pro-admin-edit-script', 'AIOSRS_Rating', apply_filters( 'wp_schema_pro_field_admin_script_localize', array( 'security' => wp_create_nonce( 'schema_nonce' ) ) ) );
				}
			}
